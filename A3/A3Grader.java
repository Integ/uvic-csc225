...
public class A3Grader {
	...
	public static void testRotate() {
		...
		try{
			list1.rotate(3);
			result = list1.frontToBack();
			displayResults(result.equals("{GHIABCDEF}"), "testRotate1");
		}catch(Exception e){
			displayResults(false, "testRotate1");
		}try{
			result = list1.backToFront();
			displayResults(result.equals("{FEDCBAIHG}"), "testRotate2");
		}catch(Exception e){
		...
		try{
			list1.rotate(2);
			result = list1.frontToBack();
			displayResults(result.equals("{EFGHIABCD}"), "testRotate3");
		}catch(Exception e){
			displayResults(false, "testRotate3");
		}
		try{
			result = list1.backToFront();
			displayResults(result.equals("{DCBAIHGFE}"), "testRotate4");
		}catch(Exception e){
		...
		try{
			list2.rotate(30);
			result = list2.frontToBack();
			displayResults(result.equals("{GHIABCDEF}"), "testRotate5");
		}catch(Exception e){
			displayResults(false, "testRotate5");
		}try{
			result = list2.backToFront();
			displayResults(result.equals("{FEDCBAIHG}"), "testRotate6");
		}catch(Exception e){
