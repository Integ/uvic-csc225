public class Exercise2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("catch AException in foo with 100");
        } catch (BException e) {
            System.out.println("catch BException in bar with 100");
        }
        ...
        try {
            ...
            System.out.println("catch AException in foo with 23");
        } catch (BException e) {
            System.out.println("catch BException in bar with 23");
        }
        ...
        try {
            ...
            System.out.println("catch AException in foo with 15");
        } catch (BException e) {
            System.out.println("catch BException in bar with 15");
        }
